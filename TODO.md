...
- [ ] VL-SAT minimal eval path 결정: faithful aligned+multi_view route vs 3D-only plumbing route
...
- [ ] VL-SAT layout prep staging policy 작성: generated annotation files와 path strategy
...
- [ ] Multi-scan evaluation is blocked until more 3RScan scan payloads are downloaded.
