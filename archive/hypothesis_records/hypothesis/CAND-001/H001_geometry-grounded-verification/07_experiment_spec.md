...
- Docker G0 scope/schema audit is complete under
  `archive/experiments/H001_geom_reliability/sources/attachment_deferred/scope_audit/`
  with status `attachment_deferred_scope_schema_ready_no_metric_execution`.
- Docker G1 extractor contract is complete under
  `archive/experiments/H001_geom_reliability/sources/attachment_deferred/evidence_extractor/`
  with status `attachment_deferred_extractor_contract_ready_no_extraction`.
- Docker G1b evidence-only dry run is complete under
  `archive/experiments/H001_geom_reliability/sources/attachment_deferred/extractor_dry_run/`
...
- Docker G1c point/surface estimator validation is complete under
  `archive/experiments/H001_geom_reliability/sources/attachment_deferred/point_surface_validation/`
...
- Docker G2 verifier-policy design is complete under
  `archive/experiments/H001_geom_reliability/sources/attachment_deferred/verifier_policy/`
  with status
...
- Docker G3 train-dev calibration/counterfactual route is complete under
  `archive/experiments/H001_geom_reliability/sources/attachment_deferred/calibration_counterfactuals/`
  with status
...
- Docker G4b error/visual sanity planning is complete under
  `archive/experiments/H001_geom_reliability/sources/attachment_deferred/error_visual_sanity/`
...
- Docker G4c strict-only calibration-filter freeze is complete under
  `archive/experiments/H001_geom_reliability/sources/attachment_deferred/strict_filter_freeze/`
...
- Docker G5a pooled strict calibration fit is complete under
  `archive/experiments/H001_geom_reliability/sources/attachment_deferred/calibration_fit/`
...
- Docker G5b bounded source scoring preflight is complete under
  `archive/experiments/H001_geom_reliability/sources/attachment_deferred/source_scoring_preflight/`
...
- Docker G5c full-source scoring/metric protocol freeze is complete under
  `archive/experiments/H001_geom_reliability/sources/attachment_deferred/full_source_protocol/`
...
results/h001_geom_reliability/figures/
