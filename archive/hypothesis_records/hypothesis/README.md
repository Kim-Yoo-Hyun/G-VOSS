...
이 폴더는 literature candidate를 검증 가능한 research hypothesis로 좁히던 산출물을 보존한다. Active workflow와 작성 규칙은 `docs/hypothesis.md`를 따른다.
...
- H001 folder: `archive/hypothesis_records/hypothesis/CAND-001/H001_geometry-grounded-verification/`
...
- Hypothesis smoke-test artifacts stay under `archive/hypothesis_records/hypothesis/CAND-001/H001_geometry-grounded-verification/artifacts/`.
