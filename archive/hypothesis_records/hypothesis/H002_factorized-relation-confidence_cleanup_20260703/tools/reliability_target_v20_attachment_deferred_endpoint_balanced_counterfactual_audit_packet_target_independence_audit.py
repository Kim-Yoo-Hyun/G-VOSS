#!/usr/bin/env python3
"""Audit target independence for H002 v20 attachment audit-packet targets."""
...
INGESTION_DIR = RGA_ROOT / "reliability_target_v20_attachment_deferred_endpoint_balanced_counterfactual_audit_packet_label_ingestion"
OUTPUT_DIR = RGA_ROOT / "reliability_target_v20_attachment_deferred_endpoint_balanced_counterfactual_audit_packet_target_independence_audit"

EXPECTED_INGESTION_STATUS = "h002_reliability_target_v20_attachment_deferred_endpoint_balanced_counterfactual_audit_packet_label_ingested_positive_sparse_with_probe_risk"
EXPECTED_NEXT_TODO = "reliability_target_v20_attachment_deferred_endpoint_balanced_counterfactual_audit_packet_target_independence_audit"
...
SCHEMA_VERSION = "h002_reliability_target_v20_attachment_endpoint_balanced_target_independence_audit_v1"
STATUS_BLOCKED_POSITIVE_SPARSE_RISK = "h002_reliability_target_v20_attachment_deferred_endpoint_balanced_counterfactual_audit_packet_target_independence_audit_blocked_positive_sparse_and_shortcut_risk"
STATUS_BLOCKED_SHORTCUT_RISK = "h002_reliability_target_v20_attachment_deferred_endpoint_balanced_counterfactual_audit_packet_target_independence_audit_blocked_shortcut_risk"
STATUS_READY = "h002_reliability_target_v20_attachment_deferred_endpoint_balanced_counterfactual_audit_packet_target_independence_audit_ready"
STATUS_ERROR = "h002_reliability_target_v20_attachment_deferred_endpoint_balanced_counterfactual_audit_packet_target_independence_audit_errors"
...
SLICE_SPECS = {
    ...
    "same_predicate_endpoint": ["predicate_label", "review_endpoint_identity"],
    "same_predicate_coverage": ["predicate_label", "review_coverage"],
    "same_predicate_gt": ["predicate_label", "gt_label_match_status_hidden"],
...
CONTROL_EQUIVALENCE = {
    ...
    "evidence_tier": {"evidence_tier", "audit_ready_state_hidden", "visual_context_state_hidden", "review_coverage"},
    "review_geometry_support": {"review_geometry_support"},
    "review_endpoint_identity": {"review_endpoint_identity"},
    "review_coverage": {"review_coverage", "evidence_tier", "audit_ready_state_hidden", "visual_context_state_hidden"},
    "review_uncertainty": {"review_uncertainty"},
    "gt_label_match_status_hidden": {"gt_label_match_status_hidden"},
    ...
    "cell_id_hidden": {"cell_id_hidden", "capacity_evidence_tier_hidden"},
    "capacity_evidence_tier_hidden": {"cell_id_hidden", "capacity_evidence_tier_hidden"},
}
...
def write_report(path: Path, summary: dict[str, Any]) -> None:
    ...
    lines = [
        "# H002 V20 Attachment Audit Packet Target Independence Audit",
        "",
    ...
    lines.extend(
        [
            ...
            "- Posterior smoke remains blocked because the primary relation target is positive-sparse and has no strict/diagnostic clear controlled slice.",
            "",
            "## Boundary",
            "",
            ...
            "- Existing GT-match axis, scan/subgraph ids, packet role, evidence tier, and label-review fields are audit/control fields only.",
