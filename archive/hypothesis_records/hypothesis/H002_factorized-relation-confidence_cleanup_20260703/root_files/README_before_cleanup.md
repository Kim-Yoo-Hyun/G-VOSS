...
current_gate = compatibility_dataset_v3_main_validation_table_materialization_after_claim_lock_ready
...
| `compatibility_dataset_v3_main_validation_table_materialization_after_claim_lock.md` | materialized caption-ready main validation table rows after claim lock |
| `tools/compatibility_dataset_v3_main_validation_table_materialization_after_claim_lock.py` | validates claim lock, skeleton table, runtime metric manifest, and writes compact main table, caveats, controls, blocked wording checklist, and next review contract |
...
The caption-ready H002 main validation table has been materialized from the
locked validation source-reranking artifacts.
...
This is still official 3DSSG validation evidence, not official test evidence.
The primary table compares `S0_source_score` and `S2_source_x_Ce`; H003 embedding
