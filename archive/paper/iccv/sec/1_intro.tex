...
\texttt{relative\_vertical}. Open3DSG is the main open-vocabulary relation
source case study, and VL-SAT is a controlled reproduced closed-set anchor
within the same H001-family scope \cite{wang2023vlsat,koch2024open3dsg}.
Controls test
