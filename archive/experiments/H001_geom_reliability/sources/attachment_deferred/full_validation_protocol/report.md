...
Created at: `2026-06-28T08:47:20+00:00`
...
- global attachment exact-label GT denominator: `1205`
...
- `open3dsg_ov`: covered `968`, missing `237`, coverage `0.8033`
- `vlsat_closed_set`: covered `1205`, missing `0`, coverage `1.0000`

## Sharding

- shard count: `99`
- expected full-source rows: `190722`
- rows per shard: `2000`
