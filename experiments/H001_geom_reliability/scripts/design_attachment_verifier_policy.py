...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--point-surface-dir",
        type=Path,
        default=Path("experiments/H001_geom_reliability/sources/attachment_deferred/point_surface_validation"),
    )
    parser.add_argument(
        "--out",
        type=Path,
        default=Path("experiments/H001_geom_reliability/sources/attachment_deferred/verifier_policy"),
    )
