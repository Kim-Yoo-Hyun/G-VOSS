...
- mode: `infer_shard`
- shard id: `qwen_full_source_shard_0014`
- selected rows: `250`
- unique pair crops: `84`

## Outputs

- `dry_run_manifest`: `experiments/H001_geom_reliability/sources/qwen_vl/full_source_runtime/dry_runs/qwen_full_source_shard_0014.json`
- `manifest`: `experiments/H001_geom_reliability/sources/qwen_vl/full_source_runtime/manifests/qwen_full_source_shard_0014.json`
- `report`: `experiments/H001_geom_reliability/sources/qwen_vl/full_source_runtime/reports/qwen_full_source_shard_0014.md`
