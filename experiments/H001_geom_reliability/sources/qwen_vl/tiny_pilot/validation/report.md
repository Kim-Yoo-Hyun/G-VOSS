...
- `parsed_jsonl`: `experiments/H001_geom_reliability/sources/qwen_vl/tiny_pilot/validation/parsed.jsonl`
- `parser_contract`: `experiments/H001_geom_reliability/sources/qwen_vl/tiny_pilot/validation/parser_contract.json`
- `manifest`: `experiments/H001_geom_reliability/sources/qwen_vl/tiny_pilot/validation/manifest.json`
- `report`: `experiments/H001_geom_reliability/sources/qwen_vl/tiny_pilot/validation/report.md`
