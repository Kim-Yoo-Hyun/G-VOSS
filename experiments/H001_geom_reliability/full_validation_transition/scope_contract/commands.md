...
- `experiments/H001_geom_reliability/full_validation_transition/scope_contract/manifest.json`
- `experiments/H001_geom_reliability/full_validation_transition/scope_contract/scope_contract.json`
- `experiments/H001_geom_reliability/full_validation_transition/scope_contract/scans.txt`
- `experiments/H001_geom_reliability/full_validation_transition/scope_contract/contexts.jsonl`
- `experiments/H001_geom_reliability/full_validation_transition/scope_contract/commands.md`
- `experiments/H001_geom_reliability/full_validation_transition/scope_contract/report.md`
