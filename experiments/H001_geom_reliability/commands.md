...
jq '.' experiments/H001_geom_reliability/active_method.json
jq '.' experiments/H001_geom_reliability/no_family_indicator_v1/fit/final_lock.json
```
...
```bash
jq '.validation' \
  experiments/H001_geom_reliability/no_family_indicator_v1/evaluation/routed_comparators/manifest.json
sed -n '1,220p' \
  experiments/H001_geom_reliability/no_family_indicator_v1/evaluation/routed_comparators/summary.md
sed -n '1,220p' results/h001_geom_reliability/report.md
```
