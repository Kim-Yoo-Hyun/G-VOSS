...
| Source | dRecall@100 (95% scan-cluster CI) | dViolation@100 (95% scan-cluster CI) |
| --- | ---: | ---: |
...
At K=100, no Recall interval crosses below zero (the VL-SAT lower bound reaches zero), and all Violation intervals remain below zero. This is a dependence sensitivity, not a new score-selection result.
