...
for shard in "${SHARDS[@]}"; do
  ...
  sg docker -c "env UID=$(id -u) GID=$(id -g) QWEN_VL_FULL_SOURCE_SHARD_ID=${shard} docker compose -f configs/qwen_vl/compose.qwen.yaml run --rm qwen_vl_full_source_infer_shard"
  rc=$?
