...
checkpoint=local_dataset/Open3DSG_staged/training_repro/mlops/opensg/mlflow/363094050435167554/25da9c4c00214f3b880cedbb2a124177/checkpoints/epoch=13-step=13104.ckpt
{
  ...
  find results/h001_geom_reliability/full_validation_transition/scope_contract -type f
  find results/h001_geom_reliability/tables -type f
...
tmux new-session -d -s h001_fullval_upload_checksums_${ts} \
  "cd /home/yoohyun/research && xargs -a results/h001_geom_reliability/full_validation_transition/artifact_bundle/upload_payload_files.txt sha256sum > results/h001_geom_reliability/full_validation_transition/artifact_bundle/upload_payload_sha256s.txt 2> logs/h001_fullval_upload_checksums_${ts}.log; rc=\$?; printf '%s\n' \"\$rc\" > logs/h001_fullval_upload_checksums_${ts}.exit; exit \"\$rc\""
```
...
wc -l \
  ...
  > results/h001_geom_reliability/full_validation_transition/artifact_bundle/upload_payload_row_counts.txt
```
