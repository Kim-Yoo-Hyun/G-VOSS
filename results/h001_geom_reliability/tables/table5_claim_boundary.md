...
| --- | --- | --- | --- |
| VL-SAT / vlsat_closed_set | full_validation_metric_ready | controlled-anchor full-validation geometry-consistency reliability result | not baseline-agnostic by itself |
