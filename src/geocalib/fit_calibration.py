#!/usr/bin/env python3
"""Fit/evaluate a small H001 p_geom_valid calibration smoke model."""
...
DEFAULT_INPUT_DIR = H001_ROOT / "artifacts" / "calibration" / "train_dev_calib"
DEFAULT_PILOT_ROOT = H001_ROOT / "artifacts" / "subset" / "h001_calib_pilot"
DEFAULT_OUTPUT_DIR = H001_ROOT / "artifacts" / "calibration" / "p_geom_valid_smoke"

MODEL_SCHEMA_VERSION = "h001_p_geom_valid_model_v1"
METRICS_SCHEMA_VERSION = "h001_p_geom_valid_metrics_v1"
SCORE_SCHEMA_VERSION = "h001_p_geom_valid_score_v1"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Fit H001 p_geom_valid calibration smoke model.")
...
def main() -> int:
    ...
    manifest = {
        "schema_version": "h001_p_geom_valid_manifest_v1",
        "created_at": metrics["created_at"],
        "status": "ready",
        "model_id": model_id,
