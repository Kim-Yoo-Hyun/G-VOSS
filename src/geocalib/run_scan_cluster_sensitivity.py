#!/usr/bin/env python3
"""Scan-cluster bootstrap sensitivity for the promoted H001 evaluation."""
...
def main() -> int:
    ...
    payload = {
        "schema_version": "h001_scan_cluster_bootstrap_sensitivity_v1",
    ...
    manifest = {
        "schema_version": "h001_scan_cluster_bootstrap_manifest_v1",
        "status": status,
        ...
        "validations": validations,
        "docker_command": "env UID=$(id -u) GID=$(id -g) docker compose -f configs/h001/compose.structured.yaml run --rm scan_cluster_sensitivity",
    }
