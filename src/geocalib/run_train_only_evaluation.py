#!/usr/bin/env python3
"""Evaluate the frozen train-only H001 scores on internal-dev or final validation."""
...
def main() -> int:
    ...
    if models.get("schema_version") != "h001_strict_train_only_calibrators_v1":
    ...
    report = {
        "schema_version": "h001_train_only_source_evaluation_v1",
