...
def main() -> int:
    ...
    summary = {
        "schema_version": "h001_structured_ablation_evaluation_v1",
        ...
        "docker_command": "env UID=$(id -u) GID=$(id -g) docker compose -f configs/h001/compose.structured.yaml run --rm structured_ablation_evaluation",
    }
    ...
    manifest = {
        "schema_version": "h001_structured_ablation_manifest_v1",
        "status": status,
        "protocol": {
