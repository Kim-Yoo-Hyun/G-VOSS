"""Shared repository paths for GeoCalib command-line entry points.
...
H001_HYPOTHESIS_REL = HYPOTHESIS_RECORDS_REL / "CAND-001" / "H001_geometry-grounded-verification"
H001_ARTIFACTS_REL = H001_HYPOTHESIS_REL / "artifacts"

H001_HYPOTHESIS_ROOT = REPO_ROOT / H001_HYPOTHESIS_REL
H001_ARTIFACTS_ROOT = REPO_ROOT / H001_ARTIFACTS_REL

EXPERIMENT_ROOT_REL = Path("experiments/H001_geom_reliability")
RESULT_ROOT_REL = Path("results/h001_geom_reliability")
ARCHIVE_EXPERIMENT_ROOT_REL = Path("archive/experiments/H001_geom_reliability")
