...
def load_eval_module(root: Path) -> Any:
    path = root / "src/geocalib/run_train_only_evaluation.py"
    spec = importlib.util.spec_from_file_location("h001_train_only_eval", path)
...
def main() -> int:
    ...
    if protocol.get("schema_version") != "h001_parameter_matched_nonlinear_rescorer_protocol_v1":
    ...
    model_payload = {
        "schema_version": "h001_parameter_matched_nonlinear_rescorer_model_v1",
    ...
    summary = {
        "schema_version": "h001_parameter_matched_nonlinear_rescorer_evaluation_v1",
    ...
    lines = [
        ...
        "This is a retrospective reviewer-requested baseline, not a prospective confirmation.", "",
    ...
    manifest = {
        "schema_version": "h001_parameter_matched_nonlinear_rescorer_manifest_v1",
        ...
        "validations": validations,
        "docker_command": "env UID=$(id -u) GID=$(id -g) docker compose -f configs/h001/compose.yaml run --rm nonlinear_fusion_baseline",
    }
