#!/usr/bin/env python3
"""Fit the four pre-registered H001 factor-isolation models on train rows only."""
...
SCHEMA_VERSION = "h001_factor_isolation_fitted_models_v1"
...
def main() -> int:
    ...
    if protocol.get("schema_version") != "h001_factor_isolation_protocol_v1":
    ...
    manifest = {
        ...
        "docker_command": "env UID=$(id -u) GID=$(id -g) docker compose -f configs/h001/compose.yaml run --rm factor_isolation_model_fit",
    }
