...
import export_calibration as exporter
import fit_calibration as calibration
import run_held_out_primitive_evaluation as heldout
...
def main() -> int:
    ...
    summary = {
        "schema_version": "h001_counterfactual_threshold_sensitivity_v1",
    ...
    manifest = {
        "schema_version": "h001_counterfactual_threshold_sensitivity_manifest_v1",
        ...
        "docker_command": "env UID=$(id -u) GID=$(id -g) docker compose -f configs/h001/compose.structured.yaml run --rm counterfactual_threshold_sensitivity",
    }
