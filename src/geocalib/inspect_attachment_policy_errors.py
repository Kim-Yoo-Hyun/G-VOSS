...
```bash
python -m py_compile src/geocalib/inspect_attachment_policy_errors.py
python -m json.tool archive/experiments/H001_geom_reliability/sources/attachment_deferred/error_visual_sanity/manifest.json >/dev/null
python -m json.tool archive/experiments/H001_geom_reliability/sources/attachment_deferred/error_visual_sanity/summary.json >/dev/null
```
