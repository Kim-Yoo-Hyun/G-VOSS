#!/usr/bin/env python3
"""Fit the strict H001 family heads without their constant family indicator.
...
import fit_calibration as calibration
import fit_strict_train_only_calibrators as strict_fit
...
def main() -> int:
    ...
    structured_models = {
        "schema_version": "h001_relation_algebra_models_v1",
        "attempts": attempts,
    ...
    write_json(
        diagnostics_path,
        {
            "schema_version": "h001_relation_algebra_diagnostics_v1",
    ...
    write_json(
        score_path,
        {
            "schema_version": "h001_no_family_indicator_score_contract_v1",
    ...
    write_json(
        lock_path,
        {
            "schema_version": "h001_no_family_indicator_final_lock_v1",
    ...
    write_json(
        manifest_path,
        {
            "schema_version": "h001_no_family_indicator_fit_manifest_v1",
            "status": status,
            ...
            "warnings": warnings,
            "docker_command": "env UID=$(id -u) GID=$(id -g) docker compose -f configs/h001/compose.structured.yaml run --rm no_family_indicator_fit",
        },
    )
    print(
        json.dumps(
