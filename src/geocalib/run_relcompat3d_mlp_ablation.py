...
import run_routed_ablation_evaluation as routed
import run_structured_ablation_evaluation as ablation
...
def main() -> int:
    ...
    summary = {
        "schema_version": "h001_relcompat3d_mlp_ablation_evaluation_v1",
        ...
        "docker_command": "env UID=$(id -u) GID=$(id -g) docker compose -f configs/h001/compose.structured.yaml run --rm relcompat3d_mlp_ablation",
    }
    ...
    manifest = {
        "schema_version": "h001_relcompat3d_mlp_ablation_manifest_v1",
        "status": status,
        "protocol": {
