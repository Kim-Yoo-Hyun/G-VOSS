...
```bash
python -m py_compile src/geocalib/run_attachment_gt_policy_smoke.py
python -m json.tool archive/experiments/H001_geom_reliability/sources/attachment_deferred/gt_policy_smoke/manifest.json >/dev/null
python -m json.tool archive/experiments/H001_geom_reliability/sources/attachment_deferred/gt_policy_smoke/summary.json >/dev/null
```
