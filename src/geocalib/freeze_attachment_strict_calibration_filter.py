...
```bash
python -m py_compile src/geocalib/freeze_attachment_strict_calibration_filter.py
python -m json.tool archive/experiments/H001_geom_reliability/sources/attachment_deferred/strict_filter_freeze/manifest.json >/dev/null
python -m json.tool archive/experiments/H001_geom_reliability/sources/attachment_deferred/strict_filter_freeze/summary.json >/dev/null
```
