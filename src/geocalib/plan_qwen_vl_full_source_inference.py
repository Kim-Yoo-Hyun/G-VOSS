        ...
        planned.append(
            {
                ...
                "dry_run_command": (
                    ...
                    "docker compose -f configs/qwen_vl/compose.qwen.yaml "
...
def build_contract(repo_root: Path, input_manifest: dict[str, Any], crop_manifest: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "runner_script": "src/geocalib/run_qwen_vl_full_source_inference.py",
        "docker_compose": "configs/qwen_vl/compose.qwen.yaml",
