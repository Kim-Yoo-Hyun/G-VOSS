#!/usr/bin/env python3
"""Run the frozen H001 relation-algebra compatibility development suite."""
...
import fit_calibration as base
import run_train_only_evaluation as evalmod
...
def main() -> int:
    ...
    summary = {
        "schema_version": "h001_relation_algebra_development_summary_v1",
    ...
    manifest = {
        "schema_version": "h001_relation_algebra_development_manifest_v1",
        "status": status,
        "created_at_utc": datetime.now(timezone.utc).isoformat(),
        "protocol": {
        ...
        "validations": validations,
        "docker_command": "env UID=$(id -u) GID=$(id -g) docker compose -f configs/h001/compose.yaml run --rm relation_algebra_development",
    }
