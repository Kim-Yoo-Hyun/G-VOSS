#!/usr/bin/env python3
"""Run the frozen raw-surface construct-validity audit for H001."""
...
def main() -> int:
    ...
    summary = {
        "schema_version": "h001_orthogonal_geometry_audit_evaluation_v1",
    ...
    manifest = {
        "schema_version": "h001_orthogonal_geometry_audit_manifest_v1",
        "status": status,
        ...
        "validations": validations,
        "docker_command": "env UID=$(id -u) GID=$(id -g) docker compose -f configs/h001/compose.structured.yaml run --rm orthogonal_geometry_audit",
    }
