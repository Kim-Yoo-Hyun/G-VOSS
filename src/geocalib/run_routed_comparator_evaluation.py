#!/usr/bin/env python3
"""Evaluate fusion comparators under the same H001 family-slot route."""
...
import run_supervision_matched_nonlinear as nonlinear
...
def main() -> int:
    ...
    summary = {
        "schema_version": "h001_routed_comparator_evaluation_v1",
    ...
    base.write_json(out / "manifest.json", {
        "schema_version": "h001_routed_comparator_manifest_v1",
        "status": status,
        ...
        "validations": validations,
        "docker_command": "env UID=$(id -u) GID=$(id -g) docker compose -f configs/h001/compose.structured.yaml run --rm routed_comparator_evaluation",
    })
