#!/usr/bin/env python3
"""Refit and evaluate H001 compatibility with verifier primitives held out."""
...
import run_structured_main_evaluation as evaluation
import run_support_routing_scan_cluster as scan_bootstrap
...
def main() -> int:
    ...
    summary = {
        "schema_version": "h001_held_out_primitive_evaluation_v1",
    ...
    write_json(models_path, {
        "schema_version": "h001_held_out_primitive_models_v1",
    ...
    manifest = {
        "schema_version": "h001_held_out_primitive_manifest_v1",
        ...
        "validations": validations,
        "docker_command": "env UID=$(id -u) GID=$(id -g) docker compose -f configs/h001/compose.structured.yaml run --rm held_out_primitive_evaluation",
    }
