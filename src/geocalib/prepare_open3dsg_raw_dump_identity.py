...
```bash
sg docker -c 'env UID=$(id -u) GID=$(id -g) OPEN3DSG_RAW_DUMP_JSONL=/workspace/{raw_rel} docker compose -f configs/h001/compose.yaml run --rm open3dsg_adapter_raw_dump'
```
