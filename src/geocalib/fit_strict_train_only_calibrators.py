#!/usr/bin/env python3
"""Fit all frozen H001 calibrators under the strict 1061/117 train firewall."""
...
from fit_factor_isolation_models import CONDITIONS, FAMILIES, PREDICATES, feature_names, numeric_stats, vectorize


SCHEMA = "h001_strict_train_only_calibrators_v1"
...
def main() -> int:
    ...
    manifest = {
        ...
        "docker_command": "env UID=$(id -u) GID=$(id -g) docker compose -f configs/h001/compose.yaml run --rm train_only_calibrator_fit",
    }
