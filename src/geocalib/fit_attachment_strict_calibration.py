...
```bash
python -m py_compile src/geocalib/fit_attachment_strict_calibration.py
python -m json.tool archive/experiments/H001_geom_reliability/sources/attachment_deferred/calibration_fit/manifest.json >/dev/null
python -m json.tool archive/experiments/H001_geom_reliability/sources/attachment_deferred/calibration_fit/metrics.json >/dev/null
```
