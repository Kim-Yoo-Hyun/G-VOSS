...
def load_renderer(root: Path) -> Any:
    ...
    spec = importlib.util.spec_from_file_location("relcompat3d_candidate_renderer", path)
...
def main() -> int:
    ...
    branch = root / "experiments/RelCompat3D_geom_reliability/no_family_indicator_v1"
    ...
    manifest = {
        "schema_version": "relcompat3d_no_family_indicator_candidate_figures_v1",
