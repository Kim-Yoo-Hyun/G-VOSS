...
The evaluation uses GT-object relation rows and exact predicate-label recall,
so even the Open3DSG result should be read as relation-reliability evidence
rather than full open-vocabulary scene graph generation performance.
