...
This checklist follows the official AAAI-27 Author Kit checked on
2026-06-11. Answers refer to the main paper plus the Docker-based experiment
artifact bundle planned for anonymous review / post-acceptance release.
...
partial. A public code/artifact release is planned, but final anonymized
review package, post-acceptance URL/DOI, and release license still need to be
fixed.
...
partial. Docker images, compose routes, mounted paths, logs, and GPU/runtime
checks are recorded. The final release package should add the exact
hardware/software manifest and artifact URL.
