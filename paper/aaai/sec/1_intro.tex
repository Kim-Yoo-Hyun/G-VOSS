...
This motivates \sysname{}, a \method{} framework. The framework treats an existing
...
reproduced closed-set anchor within the same geometry-checkable scope
...
\begin{enumerate}
    ...
    \item We introduce \sysname{}, a \method{} framework that standardizes
    prediction rows, joins identity-preserving 3D evidence, estimates
    \pgeom{}, and exposes probabilistic, rule-verified, and family-specific
    operating points.
...
explicit reproduction caveats. The claim is intentionally scoped: \sysname{} measures
