...
not use the primary family-slot route. Compared with the unrestricted
family-specific product, it can increase Recall but generally raises V,
...
\caption{\textbf{Family-specific versus pooled unrestricted products.} Cells
