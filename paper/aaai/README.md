...
| `supplement.tex` | active four-page method, dependence sensitivity, family-extension, uncertainty, and provenance supplement source |
...
- `main_aaai27.pdf`: 9 US-Letter pages; technical content continues through
  ...
  `8a3d7c133ff6e096649cb083db4a9c501e706e1edb9d084693dd0e177dd8ce86`.
- `supplement_aaai27.pdf`: 4 US-Letter pages; SHA256
...
blocking LaTeX/overfull errors. Final main log:
  ...
  `logs/h001_supp_final_review_20260715_212943.log`. Figures 1 and 3 are
...
`release/h001_aaai27_openreview_20260715_213525/`. Its outer manifest, 196-file
