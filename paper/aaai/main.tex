...
% 금지 패키지 목록(Table 2: authblk, babel, balance, cjk, epsf, epsfig, euler, float, fullpage, geometry, graphics, hyperref, layout, lmodern, navigator, pdfcomment, pgfplots, psfig, pstricks, t1enc, times, titlesec, tocbibind, ulem)
