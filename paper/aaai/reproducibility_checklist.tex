...
\begin{itemize}
	...
	partial. The paper and supplement identify frozen operating points, score
	definitions, selection chronology, and acceptance gates; no exhaustive
	...
	partial. The Code and Data Supplement includes GeoCalib preprocessing,
	...
	partial. Core scoring, calibration, metrics, and protocol scripts carry
	...
	partial. Final GeoCalib scores, K grid, thresholds, bootstrap seed/count,
	denominators, and checkpoint hashes are included. Third-party source defaults
	are referenced through their frozen Docker/config manifests.
