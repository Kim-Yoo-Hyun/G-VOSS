...
\begin{itemize}
	...
	partial. Preprocessing and metric code are prepared for release; large licensed scans, source checkpoints, and raw hidden manifests are excluded.
	...
	partial. Docker commands, metric runners, scoring code, and compact manifests are part of the release plan; licensed third-party data and checkpoints remain external dependencies.
	...
	partial. Core scoring and metric code will be documented; generated intermediate scripts and licensed-data adapters may retain compact comments only.
	...
	partial. The Docker build and software path are specified; exact host hardware may vary because the reported reranking metrics are CPU/lightweight post-processing.
