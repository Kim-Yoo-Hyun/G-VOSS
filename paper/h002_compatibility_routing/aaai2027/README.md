...
- `main.tex`: six-page technical manuscript
...
Current verified outputs are 6-page `main.pdf`, 3-page `supplement.pdf`, and
...
Figure 1 shows the claim-safe source--evidence--compatibility--reranking--
evaluation path, including the \(Z_e\notin C_e\) leakage boundary and route
status. The Method section has two module-aligned subsections. The manuscript
intentionally excludes the unvalidated PointNet, energy, and selective-decision
extensions.
