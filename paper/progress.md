...
| matched-ranking MLP, RankAvg, RRF | complete | strong comparisons under the same family-aware ranking |
| wrong predicate/pair/shuffle/swap controls | complete | Table 2 |
| distance-only and compatibility-only controls | complete | Table 2 |
...
- Figure 1 method overview, Figure 2 all-K trajectory, Figure 3 qualitative grid.
...
- supplement: `paper/aaai/supplement_aaai27.pdf`, 5 pages.
- checklist: `paper/aaai/reproducibility_checklist_aaai27.pdf`, 2 pages.
- release: `release/h001_aaai27_openreview_20260717_193626/` is the current
  verified snapshot; its extracted source reproduces the canonical PDF text.
...
- Matched MLP는 main strong comparison에 포함한다.
...
- 사용자가 다시 그린 Figure 1--3의 source-lock verification과 PDF replacement.
