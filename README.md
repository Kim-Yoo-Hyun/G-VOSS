...
Local dataset validation is passed for one sample scan. The current CAND-001 gate is selecting H001-Mini validation scan payloads with support/contact coverage.
