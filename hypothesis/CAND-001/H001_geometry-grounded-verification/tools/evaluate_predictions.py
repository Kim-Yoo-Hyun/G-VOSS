...
DEFAULT_INPUT_DIR = H001_ROOT / "artifacts" / "evaluation" / "vlsat_closed_set" / "mini"
DEFAULT_OUTPUT_DIR = H001_ROOT / "artifacts" / "evaluation" / "vlsat_closed_set" / "mini_metrics"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate H001 prediction JSONL skeleton.")
...
def main() -> int:
    ...
    metrics: dict[str, Any] = {
        "schema_version": "h001_prediction_metrics_v2",
