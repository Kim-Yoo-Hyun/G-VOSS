...
5. Write the faithful `VL-SAT` layout prep staging policy.
6. Define a calibration table schema.
7. Export a calibration table from v2-style artifacts.
8. Generate high-margin counterfactual negatives.
