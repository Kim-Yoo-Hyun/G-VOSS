...
4. Decide the minimal `VL-SAT` eval path.
5. Define a calibration table schema.
6. Export a calibration table from v2-style artifacts.
7. Generate high-margin counterfactual negatives.
