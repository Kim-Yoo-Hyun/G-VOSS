...
- `tools/fit_family_calibration.py`
- `tools/export_predictions.py`
- `tools/run_vlsat_dump.py`
- `tools/vlsat_dump_hook.py`
- `tools/join_predictions.py`
- `tools/evaluate_predictions.py`
- `tools/evaluate_gt_verifier.py`

Hypothesis-stage outputs stay under `hypothesis/.../artifacts/`. Paper-body
experiment outputs must be regenerated through Docker after experiment entry.
